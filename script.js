...
function updateMarketStatus() {
    ...
    if (isClosed) {
        ...
        elements.cooldownContainer.innerHTML = `
        ...
        const otcButton = elements.cooldownContainer.querySelector('.switch-otc-btn');
        ...
        elements.cooldownContainer.innerHTML = '<div class="timer-value" id="cooldown-timer">--:--</div>';
