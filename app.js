...
const data = [
    {
        ...
        items: [
            ...
            },
            {
                ...
                a: {
                    ru: "Создайте новый аккаунт. Верификация не нужна — доступ к боту откроется сразу.<p><ul><li> Или вы можете преобрести пожизненный доступ к полной версии бота за $100, которая также будет обновляться.</li></p>",
                    en: "Create a new account. No verification required — access to the bot will be open immediately.<p><ul><li> Or you can get lifetime access to the full version of the bot for $100, which will also receive updates</li></p>"
                }
            },
            {
